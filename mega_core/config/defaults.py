...
_C.MODEL.VID.MEGA.MIN_OFFSET = -10
_C.MODEL.VID.MEGA.MAX_OFFSET = 10
_C.MODEL.VID.MEGA.ALL_FRAME_INTERVAL = 21
_C.MODEL.VID.MEGA.KEY_FRAME_LOCATION = 10

_C.MODEL.VID.MEGA.MEMORY = CN()
_C.MODEL.VID.MEGA.MEMORY.ENABLE = True
_C.MODEL.VID.MEGA.MEMORY.SIZE = 21

...
class DatasetCatalog(object):
    ...
    DATASETS = {
        ...
        ##############################################
        "det_frames": {
            "img_dir": "customdata/train/det",
            "anno_path": "customdata/annotation/train_det",
            "img_index": "customdata/ImageSets/det_frames.txt"
        },
        "train_frames": {
            "img_dir": "customdata/train/vid",
            "anno_path": "customdata/annotation/train_vid",
            "img_index": "customdata/ImageSets/train_frames.txt"
        },
        "val_frames": {
            "img_dir": "customdata/val/images",
            "anno_path": "customdata/annotation/val",
            "img_index": "customdata/ImageSets/val_frames.txt"
        },
    ...
    def get(name, method="base"):
        if "coco" in name:
            ...
            return dict(factory="VIDMEGADataset", args=args)
        elif "val_frames" in name:
            data_dir = DatasetCatalog.DATA_DIR
            attrs = DatasetCatalog.DATASETS[name]
            args = dict(
                    image_set=name,
